...
public class UserForgetPassword extends javax.swing.JFrame {
    ...
    /**
     * Creates new form UserForgetPassword
     */
    ...
    public void Search(){
        ...
        String sql="select * from Users where User_id = '"+a1+"'";
   ...
   public void Retrieve(){
        ...
        String sql="select * from Users where Answer = '"+a2+"' and User_id='"+a1+"'";
        try{
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next()){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 131, 3), 3), "FORGOT PASSWORD", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 36), new java.awt.Color(255, 131, 3))); // NOI18N
    ...
    public static void main(String args[]) {
       ...
       //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserForgetPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
